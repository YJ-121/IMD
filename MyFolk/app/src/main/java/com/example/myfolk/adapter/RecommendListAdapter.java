...
public class RecommendListAdapter extends RecyclerView.Adapter <RecommendListAdapter.MyViewHolder>{
    private List<Folk> folkList;
//    private OnItemClickListener onItemClickListener;
    private RecyclerView recyclerView;

    public RecommendListAdapter(List<Folk> folkList){
...
//        view.setOnClickListener(this);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        Glide.with(holder.itemView)
                .load(folkList.get(position).img)
                .into(holder.recommend_img);
        holder.recommend_title.setText(folkList.get(position).title);
